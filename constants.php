...
defined('EMOJI_MEDAL1')   or define('EMOJI_MEDAL1',  iconv('UCS-4LE', 'UTF-8', pack('V', 0x1F947))); // MEDAL 1
defined('EMOJI_MEDAL2')   or define('EMOJI_MEDAL2',  iconv('UCS-4LE', 'UTF-8', pack('V', 0x1F948))); // MEDAL 2
defined('EMOJI_MEDAL3')   or define('EMOJI_MEDAL3',  iconv('UCS-4LE', 'UTF-8', pack('V', 0x1F949))); // MEDAL 3
